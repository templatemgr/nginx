...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202308272303-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  nginx --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Aug 27, 2023 23:03 EDT
# @@File             :  nginx
# @@Description      :
...
CHANGE_USER="nginx"  # Set user file ownership
CHANGE_GROUP="nginx" # Set group file ownership
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
blowfish_pass="$(__random_password 24))"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  if [ "$change_user" = "root" ] && [ "$RUNAS_USER" = "root" ]; then
    sed -i "s|^user.*|user                                         $change_user;|g" "$CONF_DIR/nginx.conf"
  else
    sed -i "s|^user.*|#user                                         $change_user;|g" "$CONF_DIR/nginx.conf"
  fi
